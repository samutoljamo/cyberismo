...
/**
 * Bypasses createCard for all but the first instance. Snapshots the seed
 * instance's directory tree once, then duplicates it on disk with fresh card
 * keys until `targetCount` is reached.
 *
